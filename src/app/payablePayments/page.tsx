...
import { PayablePayment, columns } from "./columns";
import { DataTable } from "./data-table";
import AppBarChart from "@/components/AppBarChart";

const getData = async (): Promise<PayablePayment[]> => {
  return [
    {
      id: "728ed521",
      amount: 134,
...
const PayablePaymentsPage = async () => {
  const data = await getData();
  return (
    <div className="">
      <div className="mb-8 px-4 py-2 bg-secondary rounded-md">
        <h1 className="font-semibold">All Payable Payments</h1>
      </div>
      <div className="mb-56 ">
        <AppBarChart/>
      </div>
